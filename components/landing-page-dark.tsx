    ...
    <div className="flex flex-col min-h-screen bg-gray-900 text-gray-100">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gray-700 p-6 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold mb-2 text-green-300">Sustainable Practices</h3>
                <p className="text-gray-300">We promote eco-friendly and sustainable agricultural methods.</p>
              </div>
              <div className="bg-gray-700 p-6 rounded-lg shadow-md">
                <Users className="w-12 h-12 text-green-400 mb-4" />
                <h3 className="text-xl font-semibold mb-2 text-green-300">Community Driven</h3>
                <p className="text-gray-300">Connect with a thriving community of agricultural professionals.</p>
              </div>
              <div className="bg-gray-700 p-6 rounded-lg shadow-md">
                <ShoppingCart className="w-12 h-12 text-green-400 mb-4" />
                <h3 className="text-xl font-semibold mb-2 text-green-300">Efficient Marketplace</h3>
                <p className="text-gray-300">Buy and sell agricultural products with ease and transparency.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="services" className="py-16 bg-gray-900">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-green-400">Our Services</h2>
            <div className="grid md:grid-cols-3 gap-8">
        ...
        <section id="contact" className="py-16 bg-gray-900">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-green-400">Contact Us</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold mb-4 text-green-300">Get in Touch</h3>
