...
export function LayoutDark({ children }: LayoutDarkProps) {
  return (
      ...
      <header className="bg-gray-800 shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <nav className="flex space-x-4">
            ...
            <Link href="/services-page-dark" className="text-green-300 hover:text-green-200">Services</Link>
            <Link href="/contact" className="text-green-300 hover:text-green-200">Contact</Link>
          </nav>
        </div>
      </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/signup" className="hover:text-green-200">For Farmers</Link></li>
                <li><Link href="/signup" className="hover:text-green-200">For Traders</Link></li>
                <li><Link href="/signup" className="hover:text-green-200">Resources</Link></li>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-green-300 hover:text-green-200">
